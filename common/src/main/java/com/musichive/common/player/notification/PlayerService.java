...
package com.musichive.common.player.notification;
...
import com.musichive.common.download.DownloadUseCase;
import com.musichive.common.player.PlayerManager;
import com.musichive.common.player.helper.PlayerCallHelper;
...
//            TestAlbum album = PlayerManager.getInstance().getAlbum();
            ...
            String coverPath = AppConfig.COVER_PATH + File.separator + testMusic.getMusicId() + ".jpg";
            ...
            if (bitmap != null) {
                ...
                notification.contentView.setImageViewResource(R.id.player_album_art, R.drawable.default_pic);
                notification.bigContentView.setImageViewResource(R.id.player_album_art, R.drawable.default_pic);
            }
